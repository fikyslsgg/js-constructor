...
const model = [
    new (0, _blocks.TitleBlock)("", {
        tag: "h2",
        styles: {
        }
    }),
    new (0, _blocks.TextBlock)("", {
        styles: {
        }
    }),
...
},{"./classes/blocks":"gMfMj","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./assets/image.png":"ljha9"}],"gMfMj":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
module.exports = require("8f6e561fcf177575").getBundleURL("bLxZJ") + "image.513edb25.png" + "?" + Date.now();

},{"8f6e561fcf177575":"lgJ39"}],"lgJ39":[function(require,module,exports) {
"use strict";
var bundleURL = {};
...
class Sidebar {
    ...
    add(event) {
        ...
        let newBlock;
        if (type === "text") {
            newBlock = new (0, _blocks.TextBlock)(value, {
                styles
            });
        ...
        if (type === "image") {
            newBlock = new (0, _blocks.ImageBlock)(value, {
                styles
            });
            console.log(newBlock);
        }
        if (type === "columns") {
            newBlock = new (0, _blocks.ColumnsBlock)(value, {
                styles
            });
            console.log(newBlock);
        }
...
},{"../utils":"en4he","./blocks":"gMfMj","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["ShInH","8lqZg"], "8lqZg", "parcelRequire5634")
